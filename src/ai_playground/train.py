...
# --- CONFIGURATION ---
DATASET_PATH = "src/ai_playground/dataset_processed"
OUTPUT_DIR = "src/ai_playground/model_output"
LABELS = [
    "O", 
...
def main():
    ...
    args = TrainingArguments(
        ...
        save_steps=50,
        logging_steps=10,
        use_mps_device=torch.backends.mps.is_available(), # Use Mac GPU acceleration
